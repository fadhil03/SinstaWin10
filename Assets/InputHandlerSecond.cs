...
public class InputHandlerSecond : MonoBehaviour
{
    private Camera _mainCamera;
    private GameObject _selectedPartition;
    private PartitionManagerSecond _partitionManager;
    ...
    void Awake()
    {
        ...
        _partitionManager = FindObjectOfType<PartitionManagerSecond>();
    ...
    {
        //Debug.Log("OnClick method called.");
        Vector2 mousePos;
        ...
        {
            //Debug.Log("Partition object clicked.");
        ...
        {
            //Debug.Log("UnallocatedSpace object clicked.");
            _selectedPartition = rayHit.collider.gameObject;
            if (siblingCount >= 6)
            {
